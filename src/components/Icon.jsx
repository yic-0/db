// Professional, consistent, and sleek icons based on the Lucide design system.
...
const icons = {
  ...
  // Paddle icon for Practice - Specific to Dragon Boat
  practice: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /> {/* Thunderbolt/Energy for high intensity practice */}
    </svg>
  ),
  location: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  workouts: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="m18 22 4-4" />
      <path d="m2 6 4-4" />
      <path d="m3 10 7.9-7.9a2.1 2.1 0 0 1 2.97 2.97L6 12.9a2.1 2.1 0 0 1-2.97-2.97Z" />
      <path d="m11.1 13.9 7.9-7.9a2.1 2.1 0 0 1 2.97 2.97L14.1 16.9a2.1 2.1 0 0 1-2.97-2.97Z" />
    </svg>
  ),
  // Users group for Roster
  roster: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // Organizational Chart/Boat Seats for Lineups
  lineups: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  boat: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M7.5 12V9a2.5 2.5 0 0 1 2.5-2.5h4A2.5 2.5 0 0 1 16.5 9v3" />
    </svg>
  ),
  click: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  notes: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M15 22H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h8l6 6v10a2 2 0 0 1-2 2Z" />
    </svg>
  ),
  trash: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
